 ...
 */
@RepositoryTupleEntity(value = "sensitive_level")
@Getter
@Setter
public final class YamlSensitiveLevelRuleConfiguration implements YamlRuleConfiguration {

    @RepositoryTupleField(type = RepositoryTupleField.Type.TABLE)
    private Map<String, YamlSensitiveLevelTableConfiguration> tables = new LinkedHashMap<>();
    
    @Override
    public Class<SensitiveLevelRuleConfiguration> getRuleConfigurationType() {
